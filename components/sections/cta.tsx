...
export default function CTA() {
  return (
    <div className="overflow-hidden bg-blue-50/50 pt-4 pb-12 backdrop-opacity-20 bg-cover  -mt-12 sm:mt-0 border-b border-blue-950/10">
      <div className="mx-auto max-w-7xl sm:bg-[url('/cta.png')] bg-[50%_25%] px-6 lg:px-8 py-12 border-y sm:border sm:rounded-xl p-10">
