...
export default function ContactUs() {
  return (
    <div className="overflow-hidden bg-[url('/contact.png')] bg-blue-50/40 pt-12 pb-4 sm:pt-16 sm:pb-4 backdrop-opacity-20 bg-cover bg-top -mt-12 sm:mt-0 border-b border-blue-950/10">
